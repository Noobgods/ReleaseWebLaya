(function () {
    let config = JSON.parse(`{"resolution":{"designWidth":1280,"designHeight":800,"scaleMode":"showall","alignV":"middle","alignH":"center","backgroundColor":"#bcbcbc","screenMode":"none"},"light2D":{"lightDirection":{"x":-1,"y":0,"z":1},"ambientColor":{"r":0.2,"g":0.2,"b":0.2,"a":0},"ambientLayerMask":-1,"multiSamples":4},"3D":{"lightClusterCount":{"x":12,"y":12,"z":12},"enableDynamicBatch":true,"defaultPhysicsMemory":16,"pixelRatio":1,"enableMultiLight":true,"maxLightCount":32,"maxMorphTargetCount":32},"physics2D":{"defaultConfig":{"gravity":{"x":0,"y":9.8},"allowSleeping":false,"velocityIterations":8,"positionIterations":3,"pixelRatio":50,"debugDraw":false,"drawShape":true,"drawJoint":true,"drawAABB":false,"drawCenterOfMass":false},"layers":["Default"]},"addons":{"laya.ui":"ui2"},"spineVersion":"4.2","splash":{"fit":"center","enabled":true,"duration":1},"2D":{"FPS":60,"isAntialias":true,"useRetinalCanvas":false,"isAlpha":false,"enableUniformBufferObject":true,"matUseUBO":true,"webGL2D_MeshAllocMaxMem":true,"defaultFont":"Arial","defaultFontSize":20},"physics3D":{"fixedTimeStep":0.016666666666666666,"maxSubSteps":1,"enableCCD":false,"ccdThreshold":0.0001,"ccdSphereRadius":0.0001,"layers":["Default"]},"UI":{"alwaysIncludeDefaultSkin":true,"horizontalScrollBar":"internal/UI/ScrollBarH.lh","verticalScrollBar":"internal/UI/ScrollBarV.lh","popupMenu":"internal/UI/PopupMenu.lh","tooltipsWidget":"internal/UI/Tooltips.lh","defaultTooltipsShowDelay":100,"defaultComboBoxVisibleItemCount":20},"physics3dModule":"laya.bullet","physics2dModule":"laya.box2D","stat":false,"statEnum":{"CT_FPS":true,"T_Frame_Time":true,"T_CullMain":true,"CT_OpaqueDrawCall":true,"CT_TransDrawCall":true,"CT_DepthCastDrawCall":true,"CT_ShadowDrawCall":true,"CT_DrawCall":true,"CT_Instancing_DrawCall":true,"M_GPUBuffer":true,"M_AllTexture":true,"M_RenderTexture":true,"M_GPUMemory":true,"CT_Triangle":true,"C_Sprite2DCount":true,"C_Sprite3DCount":true,"C_BaseRenderCount":true,"C_SkinnedMeshRenderCount":true,"C_ShurikenParticleRenderCount":true},"vConsole":false,"alertGlobalError":false,"dcc":{"enable":false,"generate":false,"version":"1.0.0","desc":"update resources","reserveOld":true},"startupScene":"loading.ls","pkgs":[{"path":"","autoLoad":true}]}`);
